...
if (DEV_OMICSER){
  ...
  REPO_PATH <- "/home/ricoderks/Documents/LUMC/Projects/omicser/" # "/Users/ahenrie/Projects/NDCN_dev/omicser"
  OMICSER_RUN_DIR <- file.path(REPO_PATH) #file.path(REPO_PATH,"quickstart")
